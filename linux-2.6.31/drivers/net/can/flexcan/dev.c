...
#if 0
	printk("presdiv: %d  br_progseg: %d br_pseg1: %d br_pseg2:%d \n", flexcan->br_presdiv, flexcan->br_propseg, flexcan->br_pseg1, flexcan->br_pseg2);
	printk("rate: %d div:%d bitrate:%d \n", rate, div,flexcan->bitrate);
#endif
}
