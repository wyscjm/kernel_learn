...
#include "iomux.h"
//485接口
#define uart2_485_pin 	MX25_PIN_A18
#define uart5_485_pin	MX25_PIN_A19
#define RX_485		0						/* 485接收			*/
#define TX_485		1						/* 485发送			*/
//#define DEBUG_485	
static inline void uart2_rs485_recv(void)
{
        /* 将方向变为接收 */
	gpio_set_value(IOMUX_TO_GPIO(uart2_485_pin), RX_485);
#ifdef DEBUG_485
	printk("uart2 485 recieve data <--- \n");
#endif
}
static inline void uart2_rs485_xmit(void)
{
        /* 将方向变为发送 */
	gpio_set_value(IOMUX_TO_GPIO(uart2_485_pin), TX_485);
#ifdef DEBUG_485
	printk("uart2 485 xmit data ---> \n");
#endif
}
static struct serial_rs485_zlg uart2_rs485 = {
        .delay_before_send = 10,
        .delay_after_send = 10,
        .receive = uart2_rs485_recv,
        .transmit = uart2_rs485_xmit,
};

static inline void uart5_rs485_recv(void)
{
        /* 将方向变为接收 */
	gpio_set_value(IOMUX_TO_GPIO(uart5_485_pin), RX_485);
#ifdef DEBUG_485
	printk("uart5 485 recieve data <--- \n");
#endif

}
static inline void uart5_rs485_xmit(void)
{
        /* 将方向变为发送 */
	gpio_set_value(IOMUX_TO_GPIO(uart5_485_pin), TX_485);
#ifdef DEBUG_485
	printk("uart5 485 xmit data ---> \n");
#endif

}
static struct serial_rs485_zlg uart5_rs485 = {
        .delay_before_send = 10,
        .delay_after_send = 10,
        .receive = uart5_rs485_recv,
        .transmit = uart5_rs485_xmit,
};
...
static uart_mxc_port mxc_ports[] = {
	...
	[1] = {
	       .port = {
			...
			.flags = ASYNC_BOOT_AUTOCONF,
			.line = 1,
			.private_data = &uart2_rs485,			/* modefy by zhuguojun		*/
			},
	...
	[4] = {
	       .port = {
			...
			.flags = ASYNC_BOOT_AUTOCONF,
			.line = 4,
			.private_data = &uart5_rs485,			/* modefy by zhuguojun		*/
			},
...
static int __init mxc_init_uart(void)
{
	...
	platform_device_register(&mxc_uart_device5);
 	...
 	//485方向控制
      	mxc_request_iomux(uart2_485_pin, MUX_CONFIG_ALT5);
      	mxc_iomux_set_pad(uart2_485_pin, 0);
      	gpio_request(IOMUX_TO_GPIO(uart2_485_pin), "485-1");
      	gpio_direction_output(IOMUX_TO_GPIO(uart2_485_pin), RX_485);

	mxc_request_iomux(uart5_485_pin, MUX_CONFIG_ALT5);
      	mxc_iomux_set_pad(uart5_485_pin, 0);
    	gpio_request(IOMUX_TO_GPIO(uart5_485_pin), "485-2");
      	gpio_direction_output(IOMUX_TO_GPIO(uart5_485_pin), RX_485);
